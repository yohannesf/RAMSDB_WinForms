...
{
    public partial interface IPavedSideDrainScourRepository : IRepository<RAMSDBModel.PavedSideDrainScour>
    {
        ICollection<RAMSDBModel.PavedSideDrainScour> GetAll();
        RAMSDBModel.PavedSideDrainScour GetByKey(int _ID);
    }
}
