...
{
    public partial interface IPavedSideDrainSiltRepository : IRepository<RAMSDBModel.PavedSideDrainSilt>
    {
        ICollection<RAMSDBModel.PavedSideDrainSilt> GetAll();
        RAMSDBModel.PavedSideDrainSilt GetByKey(int _ID);
    }
}
