...
{
    public partial interface IVehicleTypeRepository : IRepository<RAMSDBModel.VehicleType>
    {
        ICollection<RAMSDBModel.VehicleType> GetAll();
        RAMSDBModel.VehicleType GetByKey(int _VehicleTypeID);
    }
}
