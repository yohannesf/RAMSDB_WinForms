...
{
    public partial interface IRoadClassificationRepository : IRepository<RAMSDBModel.RoadClassification>
    {
        ICollection<RAMSDBModel.RoadClassification> GetAll();
        RAMSDBModel.RoadClassification GetByKey(int _RoadClassID);
    }
}
