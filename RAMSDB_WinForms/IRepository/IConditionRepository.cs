...
{
    public partial interface IConditionRepository : IRepository<RAMSDBModel.Condition>
    {
        ICollection<RAMSDBModel.Condition> GetAll();
        RAMSDBModel.Condition GetByKey(int _CID);
    }
}
