...
{
    public partial interface IAdminBoundaryRepository : IRepository<RAMSDBModel.AdminBoundary>
    {
        ICollection<RAMSDBModel.AdminBoundary> GetAll();
        RAMSDBModel.AdminBoundary GetByKey(int _AdminID);
    }
}
