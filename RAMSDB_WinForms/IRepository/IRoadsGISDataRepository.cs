...
{
    public partial interface IRoadsGISDataRepository : IRepository<RAMSDBModel.RoadsGISData>
    {
        ICollection<RAMSDBModel.RoadsGISData> GetAll();
        RAMSDBModel.RoadsGISData GetByKey(int _RoadID);
    }
}
