...
{
    public partial interface ICategoryofWorkRepository : IRepository<RAMSDBModel.CategoryofWork>
    {
        ICollection<RAMSDBModel.CategoryofWork> GetAll();
        RAMSDBModel.CategoryofWork GetByKey(int _CatWorkID);
    }
}
