...
{
    public partial interface IRoadSurfaceTypeRepository : IRepository<RAMSDBModel.RoadSurfaceType>
    {
        ICollection<RAMSDBModel.RoadSurfaceType> GetAll();
        RAMSDBModel.RoadSurfaceType GetByKey(int _SurfaceTypeID);
    }
}
