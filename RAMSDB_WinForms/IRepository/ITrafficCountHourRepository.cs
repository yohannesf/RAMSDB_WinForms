...
{
    public partial interface ITrafficCountHourRepository : IRepository<RAMSDBModel.TrafficCountHour>
    {
        ICollection<RAMSDBModel.TrafficCountHour> GetAll();
        RAMSDBModel.TrafficCountHour GetByKey(int _TCHourID);
    }
}
