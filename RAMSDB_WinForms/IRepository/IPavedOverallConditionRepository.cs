...
{
    public partial interface IPavedOverallConditionRepository : IRepository<RAMSDBModel.PavedOverallCondition>
    {
        ICollection<RAMSDBModel.PavedOverallCondition> GetAll();
        RAMSDBModel.PavedOverallCondition GetByKey(int _ID);
    }
}
