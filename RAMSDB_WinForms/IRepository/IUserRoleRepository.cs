...
{
    public partial interface IUserRoleRepository : IRepository<RAMSDBModel.UserRole>
    {
        ICollection<RAMSDBModel.UserRole> GetAll();
        RAMSDBModel.UserRole GetByKey(int _UserID, int _RoleID);
    }
}
