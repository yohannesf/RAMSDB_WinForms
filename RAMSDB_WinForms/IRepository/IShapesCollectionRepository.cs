...
{
    public partial interface IShapesCollectionRepository : IRepository<RAMSDBModel.ShapesCollection>
    {
        ICollection<RAMSDBModel.ShapesCollection> GetAll();
        RAMSDBModel.ShapesCollection GetByKey(int _ShapeID);
    }
}
