...
{
    public partial interface ITrafficSurveyRepository : IRepository<RAMSDBModel.TrafficSurvey>
    {
        ICollection<RAMSDBModel.TrafficSurvey> GetAll();
        RAMSDBModel.TrafficSurvey GetByKey(int _TrafficSurveyID);
    }
}
