...
{
    public partial interface IPavedEdgeStepRepository : IRepository<RAMSDBModel.PavedEdgeStep>
    {
        ICollection<RAMSDBModel.PavedEdgeStep> GetAll();
        RAMSDBModel.PavedEdgeStep GetByKey(int _ID);
    }
}
