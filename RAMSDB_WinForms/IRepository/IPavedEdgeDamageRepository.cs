...
{
    public partial interface IPavedEdgeDamageRepository : IRepository<RAMSDBModel.PavedEdgeDamage>
    {
        ICollection<RAMSDBModel.PavedEdgeDamage> GetAll();
        RAMSDBModel.PavedEdgeDamage GetByKey(int _ID);
    }
}
