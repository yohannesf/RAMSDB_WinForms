...
{
    public partial class PavedEdgeDamageRepository : EntityFrameworkRepository<RAMSDBModel.PavedEdgeDamage>, IPavedEdgeDamageRepository
    {
        public PavedEdgeDamageRepository(RAMSDBModel.RAMSDBEntities context) : base(context)
        {
        }

        public virtual ICollection<RAMSDBModel.PavedEdgeDamage> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual RAMSDBModel.PavedEdgeDamage GetByKey(int _ID)
        {
