...
{
    public partial class PavedSideDrainSiltRepository : EntityFrameworkRepository<RAMSDBModel.PavedSideDrainSilt>, IPavedSideDrainSiltRepository
    {
        public PavedSideDrainSiltRepository(RAMSDBModel.RAMSDBEntities context) : base(context)
        {
        }

        public virtual ICollection<RAMSDBModel.PavedSideDrainSilt> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual RAMSDBModel.PavedSideDrainSilt GetByKey(int _ID)
        {
