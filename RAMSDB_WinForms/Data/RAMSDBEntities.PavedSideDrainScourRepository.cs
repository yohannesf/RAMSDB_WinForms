...
{
    public partial class PavedSideDrainScourRepository : EntityFrameworkRepository<RAMSDBModel.PavedSideDrainScour>, IPavedSideDrainScourRepository
    {
        public PavedSideDrainScourRepository(RAMSDBModel.RAMSDBEntities context) : base(context)
        {
        }

        public virtual ICollection<RAMSDBModel.PavedSideDrainScour> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual RAMSDBModel.PavedSideDrainScour GetByKey(int _ID)
        {
