...
{
    public partial class PavedEdgeStepRepository : EntityFrameworkRepository<RAMSDBModel.PavedEdgeStep>, IPavedEdgeStepRepository
    {
        public PavedEdgeStepRepository(RAMSDBModel.RAMSDBEntities context) : base(context)
        {
        }

        public virtual ICollection<RAMSDBModel.PavedEdgeStep> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual RAMSDBModel.PavedEdgeStep GetByKey(int _ID)
        {
