...
{
    public partial class UserRepository : EntityFrameworkRepository<RAMSDBModel.User>, IUserRepository
    {
        public UserRepository(RAMSDBModel.RAMSDBEntities context) : base(context)
        {
        }

        public virtual ICollection<RAMSDBModel.User> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual RAMSDBModel.User GetByKey(int _UserID)
        {
            return objectSet.SingleOrDefault(e => e.UserID == _UserID);
        }
